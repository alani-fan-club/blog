...
<div class="section-index">
  ...
  <ol>
    ...
    <li><a href="#claude-skills">Claude Skills</a></li>
    <li><a href="#wtf-is-going-on-with-openai">WTF Is Going On With OpenAI</a></li>
    <li><a href="#china-model-discussion">China Model Discussion</a></li>
    <li><a href="#the-gov-and-ai-china-vs-us-stances">The Gov and AI</a></li>
    <li><a href="#cves-that-might-be-interesting">CVEs</a></li>
  </ol>
</div>
