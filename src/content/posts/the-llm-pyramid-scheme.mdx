...
<Alert label="Documented Impact" title="$40,000 in Claude 3 Opus charges — one week">
  A single proxy on stolen credentials. The account owner had no idea. <a href="https://sysdig.com/blog/llmjacking-stolen-cloud-credentials-used-in-new-ai-attack/">Sysdig report</a>
</Alert>
...
<Schematic
  label="Relay Chain"
  ariaLabel="Relay chain diagram showing API key flow"
  nodes={[
    { name: "Anthropic / Google / OpenAI", variant: "source" },
    { name: "Enterprise Key Holder", meta: "negotiated rate, lower cost", variant: "mid" },
    { name: "Third-Party Proxy", meta: "sells access, takes margin", variant: "mid" },
    { name: "You", meta: "paying most per token, knowing least", variant: "end" },
  ]}
/>
...
<Alert label="The Subsidy Gap" title="$200/month subscription → $5,000 at retail API pricing">
  Anthropic is covering that $4,800 gap. That gap is the attack surface. <a href="https://www.forbes.com/sites/annatong/2026/03/05/cursor-goes-to-war-for-ai-coding-dominance/">Forbes / Cursor analysis</a>
</Alert>
...
<Alert label="Enforcement" title="Anthropic — Overnight Ban (Jan 9, 2026)">
  Blocked third-party tools and banned accounts without warning. <a href="https://www.theregister.com/2026/02/20/anthropic_clarifies_ban_third_party_claude_access/">The Register</a>
</Alert>

<Alert label="Enforcement" title="Google — Antigravity Proxy Bans (Feb 2026)">
  Banned accounts connected to reverse proxies. Reversed bans but made position explicit: second violation is permanent. No refunds. <a href="https://indianexpress.com/article/technology/artificial-intelligence/google-bans-antigravity-users-openclaw-10547187/">Indian Express</a> | <a href="https://github.com/google-gemini/gemini-cli/discussions/20632">Google statement</a>
</Alert>
