...
<Alert label="Agent-Ready" title="The Thirteen Principles — Formatted for Your Workflow">
  Just the values, no commentary. Agents can fetch it here: <a href="/values.md">/values.md</a>
</Alert>
